...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Getgas Energen Ltd designs, installs and maintains safe LPG reticulation systems, bulk storage and piped gas infrastructure across Kenya." },
      ...
      { property: "og:description", content: "Safe, compliant LPG reticulation and bulk storage design for homes, estates and industry." },

...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-8Ep2d8Um.mjs");
...
const manifest = {
  "24d672fb73584c0403d628777d6e29971e34c8317bf1373db52c3b2cb37fcb61": {
    functionName: "submitContactForm_createServerFn_handler",
    importer: () => import("./contact.functions-ghnS3VD0.mjs")
  },
  "31aff609c51e03f2604b1f92844f581e9d1e67cdd3e1733579cce5b3f166dad0": {
    functionName: "getPublishedPost_createServerFn_handler",
    importer: () => import("./insights.functions-seUzKzt7.mjs")
  },
  "4952c4c4799545ba2ee7ad8a1485996e349fb88e5d4e4da8c6ecc41d05e8fb24": {
    functionName: "revokeStaffAccess_createServerFn_handler",
    importer: () => import("./admin.functions-MYSsjuet.mjs")
  },
  "5a228c3e058f83686bbf84bbf1c3940eb7935655bedc1a63373dccc3b74afde8": {
    functionName: "createStaffAccount_createServerFn_handler",
    importer: () => import("./admin.functions-MYSsjuet.mjs")
  },
  "5fe60e791ae1c4ab62ee6bd8909ae94dd24896e0fe96a3205532983707e7ff7f": {
  ...
  "91704ae56ad06abd0900158ccd0e953157a61b9dfb1e1d9bf34013f9d18da618": {
    functionName: "updateEnquiryStatus_createServerFn_handler",
    importer: () => import("./admin.functions-MYSsjuet.mjs")
  },
  ...
  "a9020310bc6ecdd7f84c07f6c2a87d701369e39d26a038034f1869231d902459": {
    functionName: "setStaffRole_createServerFn_handler",
    importer: () => import("./admin.functions-MYSsjuet.mjs")
  },
  "abfcbb19ad248889167b3160ca6d170f4bb6da5f34a7498639fca17fcf1302ff": {
    functionName: "getAttachmentLink_createServerFn_handler",
    importer: () => import("./admin.functions-MYSsjuet.mjs")
  },
  "bc1243debc8c647783e75940a0e8be9e80d2bba927fb3a5c5286e4de4113312a": {
    functionName: "listAllPosts_createServerFn_handler",
    importer: () => import("./admin.functions-MYSsjuet.mjs")
  },
  "c1af7edbca370233d33088c9dbe9780c1b054f6de6009e094ff0cf89de204739": {
    functionName: "listStaff_createServerFn_handler",
    importer: () => import("./admin.functions-MYSsjuet.mjs")
  },
  "cef7bc3fb7f232d49bcb94a03d6376f0ebe97c8b1e0772a40ab8f3f83f9d2304": {
    functionName: "listEnquiries_createServerFn_handler",
    importer: () => import("./admin.functions-MYSsjuet.mjs")
  },
  "daf599c6ea5ee66c12bdf6d5c84a05ee91c49a2dc1d44046f12414998a94be30": {
    functionName: "getMyAccess_createServerFn_handler",
    importer: () => import("./auth.functions-C5vL5a-O.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-fUomsfZT.mjs").then((n) => n.r),
    import("./start-DxVaxekZ.mjs"),
